...
const Contact = () => {
  const phoneNumbers = [
    ...
    { number: "8189966730", label: "Technicians" },
      ...
      content: (
        <div className="flex items-start">
          ...
          <p className="text-white">
            ...
            Koyala Gudem, Guddi Malkapur & nearby 10 km radius
          </p>
        </div>
      )
    },
  ...
  const expertise = [
    ...
    { icon: <Users size={18} />, title: "Labour Supply", description: "Security Guards, Maids, and Manpower" },
