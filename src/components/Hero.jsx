...
import { ArrowRight, Package, Clock, MapPin, ChevronDown, Wrench, Users, Home, Truck, Phone, Laptop, BookOpen, HeartPulse, ShoppingBasket } from 'lucide-react';
import { Link } from 'react-scroll';

// Hero slides with images and categories
const heroSlides = [
  // 1. Main green background slide
  {
    key: 'main',
    bgType: 'gradient',
    heading: (
  ...
  // 6. Transport, Logistics, Packers & Movers slide
  {
    key: 'transport',
    bgType: 'image',
