            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 text-white p-3">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center">
                  <span className={`w-2 h-2 rounded-full mr-1.5 ${chatStatus === 'online' ? 'bg-green-300' :
                    ...
                    return (
                      <React.Fragment key={msg._id || `msg-${index}`}>
                        ...
                        <div className={`mb-3 flex ${msg.isUser ? 'justify-end' : 'justify-start'}`}>
                          <div
                            className={`relative px-4 py-2 rounded-lg max-w-[85%] ${msg.isUser
                          ...
                          >
                            ...
                            <div className={`text-[10px] mt-1 text-right ${msg.isUser ? 'text-green-100' : 'text-gray-500'
                              }`}>
      ...
      {!msg.isUser && (
        <div className="mt-2">
          ...
          {msg.action && (
            <Link
              to={msg.action.link}
              className={`text-xs bg-gray-100 px-2 py-1 rounded-full flex items-center gap-1 w-fit ${msg.isUser ? 'text-white bg-white/20' : 'text-blue-600 hover:bg-gray-200'
                }`}
            >
