    ...
    return (
        <nav className={`fixed w-full top-0 left-0 z-50 transition-all duration-200 ${isScrolled || !isHomePage
            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center gap-7">
                    ...
                    <div className="flex items-center">
                        ...
                        <Link to="/" className="flex items-center" title="Back to Main Website">
                            ...
                            <div className="flex flex-col">
                                <span className={`font-bold text-2xl md:text-3xl tracking-tight ${isScrolled || !isHomePage
                                        ? 'bg-gradient-to-r from-green-800 via-green-700 to-emerald-600 text-transparent bg-clip-text drop-shadow-sm'
                                        : 'text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]'
                                    }`}>
                                    MACHA
                                </span>
                                <span className={`text-xs ${isScrolled || !isHomePage
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        {/* Location Selector */}
                        <div className={`hidden md:flex items-center gap-3 px-4 py-2.0 rounded-full cursor-pointer transition-all text-base ${isScrolled || !isHomePage
                        ...
                        <div className="hidden lg:flex space-x-2">
                            <NavLink
                                ...
                                className={({ isActive }) => `px-5 py-3 rounded-xl text-lg font-semibold transition-colors ${isActive
                    ...
                    <div className="hidden md:block lg:flex-grow lg:max-w-2xl mx-6">
                        <div className="relative">
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-3 rounded-full text-base font-medium border-none ${isScrolled || !isHomePage
                            ...
                            />
                            <Search className={`absolute left-4 top-1/2 transform -translate-y-1/2 ${isScrolled || !isHomePage ? 'text-gray-400' : 'text-white/70'
                                }`} size={20} />
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <a
                            ...
                            className={`group flex items-center gap-2 px-5 py-2.5 rounded-full font-semibold text-base transition-all transform hover:scale-105 ${isScrolled || !isHomePage
                        ...
                        <Link to="/grocery/cart" className="relative">
                            <div className={`flex items-center justify-center h-11 w-11 rounded-full hover:bg-opacity-80 transition ${isScrolled || !isHomePage ? 'bg-gray-100 text-gray-700 hover:bg-gray-200' : 'bg-white/20 text-white hover:bg-white/30'
                                }`}>
                                <ShoppingBag size={24} />
                                {cartCount > 0 && (
                        ...
                        <div className="relative" ref={dropdownRef}>
                            <button
                                ...
                                className={`flex items-center justify-center h-11 w-11 rounded-full transition-all ${isScrolled || !isHomePage
                    ...
                    <div className="flex items-center md:hidden">
                        ...
                        <Link to="/grocery/cart" className="relative mr-2">
                            <div className={`flex items-center justify-center h-10 w-10 rounded-full ${isScrolled || !isHomePage ? 'bg-gray-100 text-gray-700' : 'bg-white/20 text-white'
                                }`}>
                                <ShoppingBag size={20} />
                                {cartCount > 0 && (
                        ...
                        <button
                            onClick={toggleMenu}
                            type="button"
                            className={`inline-flex items-center justify-center p-2 rounded-md ${isScrolled || !isHomePage ? 'text-gray-700 hover:bg-gray-100' : 'text-white hover:bg-white/20'
                                }`}
                        >
            ...
            <div className="px-4 mt-2 pb-2 md:hidden">
                <div className="relative">
                    <input
                        ...
                        className={`w-full pl-10 pr-4 py-2 rounded-full border-none ${isScrolled || !isHomePage
                                ? 'bg-gray-100 focus:bg-white focus:ring-2 focus:ring-green-500 text-gray-800'
                                : 'bg-white/20 focus:bg-white/30 text-white placeholder:text-white/70 focus:ring-2 focus:ring-white/50'
                            } transition-colors`}
                    />
                    <Search className={`absolute left-3 top-1/2 transform -translate-y-1/2 ${isScrolled || !isHomePage ? 'text-gray-400' : 'text-white/70'
                        }`} size={18} />
                </div>
            </div>
            ...
            <div className="px-4 pb-2 md:hidden">
                <div className={`flex items-center gap-2 rounded-full py-1 px-3 ${isScrolled || !isHomePage ? 'bg-gray-100 text-gray-700' : 'bg-white/20 text-white'
                    }`}>
