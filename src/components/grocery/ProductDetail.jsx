                ...
                {product.images.length > 1 && (
                    <div className="flex justify-center space-x-2">
                        {product.images.map((img, idx) => (
                            <button
                                key={idx}
                                className={`w-12 h-12 rounded-md overflow-hidden border-2 ${idx === currentImageIndex ? 'border-green-500' : 'border-gray-200'
                                    }`}
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {product.variations.map(variant => (
                                <button
                                    key={variant.id}
                                    className={`px-3 py-1.5 border rounded-lg text-sm ${selectedVariation?.id === variant.id
            ...
            <div className="bg-white rounded-xl shadow-sm mb-4 overflow-hidden">
                <div className="flex border-b">
                    <button
                        ...
                        className={`py-3 px-4 text-sm font-medium flex-1 text-center ${activeTab === 'description'
                    ...
                    <button
                        ...
                        className={`py-3 px-4 text-sm font-medium flex-1 text-center ${activeTab === 'nutrition'
                                ? 'text-green-600 border-b-2 border-green-600'
                                : 'text-gray-500'
                            }`}
                    >
