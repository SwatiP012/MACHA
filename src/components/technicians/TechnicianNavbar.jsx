                ...
                <div className="flex justify-between items-center">
                    ...
                    <nav className="hidden md:flex items-center space-x-10">
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `font-medium text-lg transition-colors ${isScrolled
                        ...
                        <div className="relative group">
                            <button
                                className={`flex items-center font-medium text-lg ${isScrolled
                                    ...
                                    >
                                        {services.map((service, index) => (
                                            <NavLink
                                                ...
                                                to={service.path}
                                                className={({ isActive }) =>
                                                    `block px-5 py-3 text-base hover:bg-gray-50 transition-colors flex items-center ${isActive ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-700'
                                                    }`
                                                }
                                            >
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <a
                            ...
                            className={`px-5 py-2.5 flex items-center text-base font-medium rounded-lg transition-all ${isScrolled
                        ...
                        <Link
                            to="/book"
                            className={`px-5 py-2.5 text-base font-medium rounded-lg transition-all ${isScrolled
                                                    ...
                                                    {services.map((service, index) => (
                                                        <motion.div key={index} variants={menuItemVariants}>
                                                            <NavLink
                                                                to={service.path}
                                                                className={({ isActive }) =>
                                                                    `block py-2 text-lg flex items-center ${isActive ? 'text-green-700 font-medium' : 'text-gray-700'
                                                                    }`
                                                                }
                                                            >
                                                                <span className="mr-3 text-green-600">{service.icon}</span>
