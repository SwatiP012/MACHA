                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full bg-white">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {orders.map((order) => (
                            <tr key={order._id}>
                              <td className="py-4 px-4 text-sm">{order.orderNumber || order._id.substring(0, 8)}</td>
                              <td className="py-4 px-4 text-sm">{formatDate(order.createdAt)}</td>
                              <td className="py-4 px-4 text-sm">{order.serviceType || 'N/A'}</td>
                              <td className="py-4 px-4 text-sm font-medium">₹{order.totalAmount || 'N/A'}</td>
                              ...
                              <td className="py-4 px-4">
                                <Link to={`/order/${order._id}`} className="text-green-600 hover:text-green-800 text-sm font-medium">
                                  View Details
                                </Link>
                              </td>
                            </tr>
