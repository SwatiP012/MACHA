            ...
            <div className="grid text-black grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {orderStatuses.filter(status => status.id !== 'all').map(status => (
                    <button
                        ...
                        className={`bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:border-${status.color}-300 transition-colors ${statusFilter === status.id ? `bg-${status.color}-50 border-${status.color}-300` : ''
                            }`}
                    >
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Status
                                                ...
                                                <th scope="col" className="px-6 text-black py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr className={`hover:bg-gray-50 ${expandedOrderId === order._id ? 'bg-gray-50' : ''}`}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div className="flex justify-end items-center space-x-2">
                                                        ...
                                                        <select
                                                            className="text-sm text-black border border-gray-200 rounded p-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                            value={order.status}
