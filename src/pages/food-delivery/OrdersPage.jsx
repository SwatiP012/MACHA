        ...
        <div className="min-h-screen bg-gray-50 pt-3 pb-10">
            <div className="container mx-auto px-4">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-center flex-grow pr-16">Your Orders</h1>
                </div>
                                            ...
                                            <div className="border-b border-gray-100 p-4">
                                                <div className="flex flex-wrap items-center justify-between gap-2">
                                                    ...
                                                    <div className="flex items-center space-x-3">
                                                        ...
                                                        <div className="font-medium text-gray-900">₹{(order.total || order.orderTotal || 0).toFixed(2)}</div>
                                                    </div>
                                                </div>
                                            </div>

                                            {/* Order brief info */}
                                            <div className="p-4 flex items-center justify-between cursor-pointer" onClick={() => toggleOrderDetails(order.id)}>
