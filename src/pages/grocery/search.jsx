                                        ...
                                        <div className="p-2">
                                            {sortOptions.map(option => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-2 rounded-md text-sm ${activeSort === option.id ? 'bg-green-50 text-green-700' : 'hover:bg-gray-50'
                                                        }`}
                                                >
                                                    {option.name}
                                                </button>
                                    ...
                                    <div className="absolute right-0 mt-1 w-56 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                                        <div className="p-2">
                                            {filterOptions.map(option => (
                                                ...
                                                >
                                                    {option.name}
                                                    <div className={`w-4 h-4 border rounded ${activeFilters.includes(option.id) ? 'bg-green-500 border-green-500' : 'border-gray-300'
                                                        }`}>
