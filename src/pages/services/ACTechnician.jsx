    ...
    return (
        <div className="bg-gradient-to-b from-white to-gray-50 pb-16">
            ...
            <section className="relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] lg:min-h-[93vh]  mt-3 py-24 bg-gradient-to-b from-green-900/60 to-green-700/70 mix-blend-multiply">
                <div className="absolute inset-0 bg-opacity-70 bg-[url('https://img.freepik.com/premium-photo/maintenance-air-conditioning-service-man-with-drill-working-ventilation-filter-ac-repair-contractor-handyman-electric-aircon-machine-expert-problem-solving-cleaning-dust-tools_590464-212340.jpg?ga=GA1.1.1872067447.1750850496&w=740')] bg-cover bg-center mix-blend-overlay"></div>
