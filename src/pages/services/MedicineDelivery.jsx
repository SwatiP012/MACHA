                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid text-black grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        },
                        {
                            ...
                            title: "OTC Products",
                            description: "Access a wide range of over-the-counter medications, vitamins, supplements, and personal care products without leaving your home. Simply place your order and receive it within hours.",
                            benefits: ["No prescription needed", "Wide product selection"],
                            image: "https://media.istockphoto.com/id/1333575297/photo/professional-pharmacist-near-shelves-in-drugstore-focus-on-hand.webp?a=1&b=1&s=612x612&w=0&k=20&c=z2LeyFPj3wzOmZoVcsGGpaakPNc6CFCmNpdAQhWMFKc="
                        },
                        {
