...
// Modern timeline step component - Reverted to original as per user's request for new 'How It Works'
...
const Technicians = () => {
    ...
    const howItWorksSteps = [
        {
            ...
            img: "https://img.freepik.com/premium-photo/young-men-planning-vacation-trip-searching-information_38391-633.jpg?ga=GA1.1.1872067447.1750850496&semt=ais_hybrid&w=740",
        },
        {
            title: "Technician Visit",
            desc: "Our skilled technician arrives at your location with all necessary tools and materials.",
            img: "https://img.freepik.com/free-photo/greetings-joyful-man-woman-standing-with-back-camera-shaking-hands_259150-58289.jpg?ga=GA1.1.1872067447.1750850496&semt=ais_hybrid&w=740",
        },
        {
            title: "Job Execution",
            desc: "The technician completes the work with quality craftsmanship and explains the process.",
    ...
    return (
        <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
            {/* Hero Section - Redesigned with green/black theme and background image */}
            <section
                className="relative min-h-screen flex items-center  justify-center overflow-hidden bg-cover bg-center"
                style={{ backgroundImage: `url('https://c8.alamy.com/comp/D9REHH/collage-of-carpenter-working-D9REHH.jpg')` }}
            >
                <div className="absolute inset-0 bg-green-900 opacity-70 z-0"></div> {/* Dark overlay */}
                ...
                <div className="container mx-auto px-5 relative z-10 text-center py-16">
                    ...
                    >
                        <img src={machaLogo} alt="MACHA Logo" className="h-28 rounded-lg shadow-2xl" />
                    </motion.div>
                    ...
                    >
                        <a
                            ...
                            className="px-8 py-4 bg-white text-green-800 font-bold rounded-full hover:bg-green-50 transition-all hover:-translate-y-2 hover:shadow-xl flex items-center text-lg"
                        >
                            <Phone className="w-6 h-6 mr-3" /> Call Us Now
                        </a>
                        <Link
                            to="/book"
                            className="px-8 py-4 bg-green-600 text-white font-bold rounded-full hover:bg-green-700 transition-all hover:-translate-y-2 hover:shadow-xl flex items-center text-lg"
                        >
                            <Calendar className="w-6 h-6 mr-3" /> Book A Technician
                        </Link>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="mt-20 bg-white bg-opacity-15 backdrop-blur-sm rounded-3xl p-6 flex flex-wrap justify-around shadow-lg border border-green-200 border-opacity-30 max-w-4xl mx-auto"
                    >
            ...
            <section className="py-20 bg-gray-30">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <img src={machaLogo} alt="MACHA Logo" className="h-12 mx-auto mb-6 opacity-80" />
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-green-100">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
            ...
            {/* How It Works - New design with image-based steps */}
            <section className="py-20 bg-gray-100">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <div className="w-28 h-1.5 bg-green-700 mx-auto mb-6 rounded-full"></div>
                        <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                            Our simple process ensures you get quick and reliable technical services without any hassle.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-7xl mx-auto">
                        {howItWorksSteps.map((step, index) => (
                            <motion.div
                                key={index}
                                className="bg-white rounded-2xl p-8 shadow-xl text-center border-t-6 border-green-700 hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 group relative overflow-hidden"
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex justify-center mb-6">
                                        <div className="w-52 h-52 rounded-xl border-4 border-green-200 overflow-hidden flex items-center justify-center shadow-inner group-hover:border-green-400 transition-all duration-500">
                                            <img
                                                src={step.img}
                                                alt={`Step ${index + 1}`}
                                    ...
                                    <h3 className="font-extrabold text-2xl mb-3 text-green-800 group-hover:text-green-900 transition-colors duration-300">
                                        {step.title}
                                    </h3>
                                    <p className="text-gray-600 text-base">{step.desc}</p>
                                </div>
                                <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-green-100 rounded-full flex items-center justify-center text-green-700 font-bold text-4xl opacity-0 group-hover:opacity-100 transition-all duration-500 scale-0 group-hover:scale-100">
                                    {index + 1}
                                </div>
                            </motion.div>
                        ))}
